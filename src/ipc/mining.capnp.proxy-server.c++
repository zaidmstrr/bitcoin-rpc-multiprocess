...
kj::Promise<void> ProxyServer<ipc::capnp::messages::Mining>::createNewBlock(CreateNewBlockContext call_context) {
    return serverInvoke(*this, call_context, MakeServerField<0, Accessor<mining_fields::Context, FIELD_IN | FIELD_BOXED>>(MakeServerField<1, Accessor<mining_fields::Options, FIELD_IN | FIELD_BOXED>>(MakeServerField<1, Accessor<mining_fields::Cooldown, FIELD_IN>>(Make<ServerRet, Accessor<mining_fields::Result, FIELD_OUT | FIELD_BOXED>>(ServerCall())))));
}
kj::Promise<void> ProxyServer<ipc::capnp::messages::Mining>::checkBlock(CheckBlockContext call_context) {
    return serverInvoke(*this, call_context, MakeServerField<0, Accessor<mining_fields::Context, FIELD_IN | FIELD_BOXED>>(MakeServerField<1, Accessor<mining_fields::Block, FIELD_IN | FIELD_BOXED>>(MakeServerField<1, Accessor<mining_fields::Options, FIELD_IN | FIELD_BOXED>>(MakeServerField<1, Accessor<mining_fields::Reason, FIELD_OUT | FIELD_BOXED>>(MakeServerField<1, Accessor<mining_fields::Debug, FIELD_OUT | FIELD_BOXED>>(Make<ServerRet, Accessor<mining_fields::Result, FIELD_OUT>>(ServerCall())))))));
}
...
kj::Promise<void> ProxyServer<ipc::capnp::messages::BlockTemplate>::waitNext(WaitNextContext call_context) {
    return serverInvoke(*this, call_context, MakeServerField<0, Accessor<mining_fields::Context, FIELD_IN | FIELD_BOXED>>(MakeServerField<1, Accessor<mining_fields::Options, FIELD_IN | FIELD_BOXED>>(Make<ServerRet, Accessor<mining_fields::Result, FIELD_OUT | FIELD_BOXED>>(ServerCall()))));
}
